...
public class ConfAnnotator_exception extends Thread{
    ...
    public static  void  main(String[] args){
        Thread confAnnotator1 = new ConfAnnotator_exception(0,9999,"in.txt");
        Thread confAnnotator2 = new ConfAnnotator_exception(10000,19999,"in1.txt");
    ...
    public ConfAnnotator_exception(int start,int end,String filename){
        setStart(start);
        setEnd(end);
    ...
    public void getDataFromDB(){
        ...
        try {
            ...
            String sql = "select exception_id,name,handled_description from jdk_exception ";
            ResultSet rs = statement.executeQuery(sql);

            while(rs.next()) {
                setId(rs.getInt("exception_id"));
                ...
                String sql1 = "update jdk_exception set conf_description = \""+str+"\" where exception_id = "+id;
